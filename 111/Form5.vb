...
Public Class Form5
    ...
    Private Sub absbButton_CheckStateChanged(sender As Object, e As EventArgs)
    ...
    Private Sub CheckBox6_CheckStateChanged(sender As Object, e As EventArgs)
    ...
    Private Sub btnGoUp_Click(sender As Object, e As EventArgs)
        ' 检查 toForm1Path 是否为空
    ...
    Private Sub TreeView1_BeforeCollapse(sender As Object, e As TreeViewCancelEventArgs)
    ...
    Private Sub Form5_DoubleClick(sender As Object, e As EventArgs)
        Me.CenterToScreen()
    End Sub
    ...
    Private Sub TreeView1_DragEnter(sender As Object, e As DragEventArgs)
        ' 判断拖入的是否是文件夹
    ...
    Private Sub Form5_SizeChanged(sender As Object, e As EventArgs)
