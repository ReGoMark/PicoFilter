...
>[!CAUTION]
>安装 [方正黑体_GBK](./Fonts/方正黑体GBK.ttf)字体提升视觉效果体验。字体文件已经附在 [Fonts 文件夹](./Fonts) 中；程序运行的最小分辨率为 `720P` ，低于该分辨率运行时可能出现布局错误问题。
>
>感谢开源社区的支持，没有开源社区就没有 PicoFilter 的诞生。本程序完全免费开源，仅供交流和学习使用，禁止用于商业用途或未经授权的分发。
